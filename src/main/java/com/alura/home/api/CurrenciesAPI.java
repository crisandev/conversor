...
public class CurrenciesAPI implements ApiJSONFiles {
    ...
    private static final String JSON_CURRENCIES_URL_ES = Utilities.getPath("currencies-countries-es.json");
//    private static final String JSON_CURRENCIES_URL_ES = "src/main/resources/json-files/currencies-countries-es.json";
    private static final String JSON_CURRENCIES_URL_EN = Utilities.getPath("currencies-countries-en.json");
